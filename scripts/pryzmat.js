...
function init()
{
    ...
    V = mat4.create();
	uM = mat4.create();
    mat4.perspective(P, Math.PI/4, 1, 0.1, 15) // takie same jednostki jak w lookAT
    mat4.lookAt(V,[1, 1.5, 4],[0,0,0],[0, 1, 0])
	...
	var vertices = new Float32Array( [
        -0.5, 0, 0.5,           // lewy przod 0
		0, 1, 0,		        //szyt 1
		0.5, 0, 0.5,        // prawy przod 2
		-0.5, 0, -0.5,		//lewy tyl 3
		0.5, 0, -0.5,         //prawy tyl 4
...
function draw()
{
    ...
    exTime = now;
    var angle = Math.PI * 1 * elapsed/onerev;
